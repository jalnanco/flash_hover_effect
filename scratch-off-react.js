...
function draw(context, scratchContext, background, foreground, displaySize) {
  ...
  //
  context.restore();
  scratchContext.clearRect(0, 0, displaySize.width, displaySize.height);
}
...
function eraseScratchLine(
  ...
  scratchContext.arc(
    scratchPosition.startX,
    scratchPosition.startY,
    100,
    0,
    2 * Math.PI,
    false
  );
  scratchContext.fillStyle = "green";
  scratchContext.fill();
  scratchContext.lineWidth = 5;
